...
const handleRequest = function(mjAPI, request, response) {
  var str_params = '';
...
const start = function(port) {
  if (cluster.isMaster) {
    ...
    cluster.on('disconnect', function(worker) {
      console.error('A worker was disconnected; restarting...');
      cluster.fork();
    });
...
module.exports = mathjaxServer;


// If we were called from the command line, start the server.
